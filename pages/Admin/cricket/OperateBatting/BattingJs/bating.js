...
$(document).ready(()=>{
    $("#add").click(()=>{
       ...
       if(localStorage.getItem(name+"batting")!=null){
        ...
        var addDetails={Name:name,NumberOf4s:numberOf4s,NumberOf6s:numberOf6s,OtherRun:otherRun,Status:status,Extras:extraRun,Run:run,Ball:ball};
...
$(document).ready(()=>{
    ...
    for(i=0;i<localStorage.length;i++){
        ...
        if(keys.match("batting")){
            ...
            var div2_r=$("<div class='table_column2'></div>").text(json_extract.Run);
            var div2_b=$("<div class='table_column2'></div>").text(json_extract.Ball);
            var div2_4s=$("<div class='table_column2'></div>").text(json_extract.NumberOf4s);
            var div2_6s=$("<div class='table_column2'></div>").text(json_extract.NumberOf6s);

            var div1_nm=$("<p class='p_nm'></p>").text(json_extract.Name);
            var div1_stat=$("<p class='p_status'></p>").text(json_extract.Status);

            var div1=$("<div class='table_column1'></div>").append(div1_nm,div1_stat);
            var div2=$("<div class='score_headingid'></div>").append(div2_r,div2_b,div2_4s,div2_6s);
            var div3=$("<div style='width: 93%; height: 2px;border: 1px solid #fff;background-color: gray;'></div>").text();
    ...
    var footerSection1=$("<div class='footer_score'></div>").append(name1,val1);
    var footerSection2=$("<div class='footer_score'></div>").append(div4,name2,val2);

    var total_rn=$("<p class='run_footer_prev'></p>").text(total+"/"+wicket+" (0."+totalBall+")");
    var footerScore=$("<div class='footer_score'></div>").append(total_rn);
    var scorePreviewSection=$(".first_team_score_preview").append(footerSection1,footerSection2,footerScore);
});
...
$(document).ready(()=>{
    ...
    var total_rn=$("<p class='run_footer_prev'></p>").text(total+"/"+wicket+" (0."+totalBall+")");
    var footerScore=$("<div class='footer_score'></div>").append(total_rn);
    var scorePreviewSection=$(".first_team_score_preview2").append(footerSection1,footerSection2,footerScore);
});